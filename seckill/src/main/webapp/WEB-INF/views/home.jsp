...
<nav class="navbar navbar-default navbar-static-top">
    <div class="container">
        ...
        <a href="/product/new" class="btn btn-default navbar-btn pull-right"><i class="fa fa-plus"></i> 添加商品</a>
    </div>
</nav>
<div class="container">
        ...
        <div class="panel-body">
            <c:forEach items="${productList}" var="product">
                <div class="row product_list">
                    <div class="col-md-2">
                        <img src="http://ozp3l84j4.bkt.clouddn.com/${product.productImage}?imageView2/1/w/150/h/150/q/75" alt="">
                    </div>
                    <div class="col-md-10">
