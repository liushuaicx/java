        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview ${fn:startsWith(param.menu, 'sale_') ? 'active' : ''}">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="${param.menu == 'sale_my'? 'active' : ''}"><a href="/sale/my"><i class="fa fa-circle-o"></i> 我的机会</a></li>
                </ul>
            </li>
            <!-- 待办事项 -->
            ...
            <li class="treeview ${fn:startsWith(param.menu, 'charts_') ? 'active' : ''}">
                ...
                <ul class="treeview-menu">
                    <li class="${param.menu == 'charts_list'? 'active' : ''}"><a href="/charts"><i class="fa fa-circle-o"></i> 客户统计</a></li>
                </ul>
            </li>
