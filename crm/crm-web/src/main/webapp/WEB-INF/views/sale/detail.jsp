        ...
        <section class="content">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <a href="/sale/my" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> 返回列表</a>
                        <button id="delBtn" rel="${saleChance.id}" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i> 删除</button>
                    </div>
                </div>
            ...
            <div class="modal fade" id="changeProgressModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="/sale/my/${saleChance.id}/progress/update" id="updateProgressForm">
